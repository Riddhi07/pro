...
{ 
   String iid=rs1.getString(1);
    ...
    i++;
                       %>
                       <option class="dropdown-item form-control" value="<%=iid%>" name="uid">   <%=i%>).  <%=name%> </option> 
...
con.close();  
                ...
                <div class="form-group">
              <div class="col-sm-10">
                  <input type="text" class="form-control" placeholder="Obtained Marks" name="marks"  value="<%=marks%>">
                  </div>
                </div>
        ...
        <div class="row mt">
         ...
         <div class="row mt">
        <div class="col-lg0-12">
        <div class="form-panel">
         <form class="form-horizontal style-form" method="get">
                  <table class="table table-bordered table-striped table-condensed">
                  <thead>
                    <tr>
                      <th width="25%" class="numeric"><h4>Result ID</h4></th>
                      <th width="25%" class="numeric"><h4>Registration ID</h4></th>
                        <th width="25%" class="numeric"><h4>Obtained Marks</h4></th>
                          <th width="25%">
