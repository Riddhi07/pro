...
"jdbc:mysql://localhost:3306/proadmin","root","");  
Statement stmt=con.createStatement();  
stmt.executeUpdate("insert into subcat(catid,subname,nop) values('"+a+"','"+sub+"','"+nop+"')");
...
"jdbc:mysql://localhost:3306/proadmin","root","");  
Statement stmt=con.createStatement();  
stmt.executeUpdate("update subcat set catid='"+a+"',subname='"+sub+"',nop='"+nop+"' where subid='"+id+"'");
response.sendRedirect("subcat.jsp?id=0");
con.close();  
}catch(Exception e){ System.out.println(e);} 
}
 ...
 if(str.equals("rlt"))
{
    ...
    int rid =Integer.parseInt(request.getParameter("regid"));
...
//here sonoo is database name, root is username and password  
Statement stmt=con.createStatement();  
stmt.executeUpdate("insert into result(regid,tid,marks,date)values('"+rid+"','"+tid+"',"+obtm+"', '"+dt+"')");
...
"jdbc:mysql://localhost:3306/proadmin","root","");  
Statement stmt=con.createStatement();  
stmt.executeUpdate("update category set regid='"+rid+"' tid='"+tid+"' marks='"+obtm+"' date='"+dt+"' where catid='"+id+"'");
response.sendRedirect("result.jsp?id=0");
con.close();  
}catch(Exception e){ System.out.println(e);}  
}
